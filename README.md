...
rfm_segments.csv
        ...
        ▼
dashboard_executive.html  +  dashboard_operative.html
```
...
python3 build_dashboards.py   # → dashboard_data.json, dashboard_*.html
```
...
| `dashboard_executive.html` | Leadership dashboard — KPIs, revenue concentration, customers-vs-revenue imbalance, and seasonal trend, filterable by country. |
| `dashboard_operative.html` | Marketing/CRM workspace — per-segment detail, campaign plays, and a searchable, sortable, exportable customer table. |
| `README.md` | This file. |
